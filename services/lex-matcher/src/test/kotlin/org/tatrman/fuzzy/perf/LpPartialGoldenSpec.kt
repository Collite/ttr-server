...
class LpPartialGoldenSpec :
    StringSpec({
        ...
        suspend fun answers(version: MatchVersion): Map<String, List<FuzzyMatchResult>> {
            val fixture = PerfFixture.of(mapOf(CATEGORY to corpus), RetrievalMode.INDEX_FIRST, version)
            try {
